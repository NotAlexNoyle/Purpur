...
true-og/Purpur is a fork of Purpur for 1.19.4 by [TrueOG Network](https://trueog.net) with small QoL patches for our server.
...
- Stores player data in RocksDB instead of `.dat` files.
